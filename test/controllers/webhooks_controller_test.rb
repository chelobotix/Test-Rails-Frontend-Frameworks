...
class WebhooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webhook" do
    assert_difference('Webhook.count') do
      post webhooks_url, params: { webhook: { data: @webhook.data, event: @webhook.event, message: @webhook.message, source: @webhook.source } }
    end
  ...
  test "should update webhook" do
    patch webhook_url(@webhook), params: { webhook: { data: @webhook.data, event: @webhook.event, message: @webhook.message, source: @webhook.source } }
